...
public class StringUtilTest {
  ...
  public void testSplitAndTrim() {
    String[][][] testCases = { { { "a" }, { "a" }, { "b" }, { "a" } }, { { "    a" }, { "a" }, { "b" }, { "a" } },
        { { "a    b" }, { "a", "b" }, { "b" }, { "a" } },
        { { "da    b cd ddd e    d " }, { "da", "b", "cd", "ddd", "e", "d" }, { "d" },
            { "", "a    b c", "", "", "", "e" } }, };
  ...
  public void testToHexString() {
    Object[][] testCases = { { "0", "00", 0, 1, 1, 1, "00 ", "00 " }, { "127", "7f", 0, 1, 1, 2, "7f ", "7f " },
        { "128", "0080", 0, 1, 1, 1, "00 ", "00 80 " }, { "128", "0080", 1, 1, 1, 2, "80 ", "00 80:" },
  ...
  private void checkToHexString(String val, String expected, int offset, int length, int minorGroupSize,
      int majorGroupSize, String expectedAll, String expectedByteBuffer) {
    ...
    //        StringUtil.hexStringToByteBuffer(valAsHex));
    //        assertArrayEquals(getTestMessage(testName, valAsHex),                                       bb.array(),
    //        StringUtil.hexStringToByteBuffer(valAsHex).array());
  }
  ...
  public void testNextByteChars() {
    ...
    Object[][] testCases = { { "  ", 0, null },
        //            {"0",      0, "0"},
        { "00", 0, "00" },
        //            {"FF",     0, "FF"},
        { intInHex, 0, "00" }, { intInHex, 1, "08" }, { intInHex, 2, "80" }, { bigHex, 2, "9d" }, { bigHex, 3, "d7" },
        { bigHex, 13, "0c" }, { bigHex, 14, "c0" },
        // what about bigHex with uppercase letters?
        //            {bigHex,  23, "f"},
        { bigHex, 50, null }, { "02   9d::73e6:cbe0 c04f:ffff:", 2, "9d" }, };
  ...
  public void testIsHexDigit() {
    Object[][] testCases = { { '0', true }, { '5', true }, { '9', true }, { 'a', true },
        //            {'C', true },
        //            {'F', true },
        { 'G', false }, };
  ...
  public void testToString() {
    Object[][] testCases = { { new String[][] { { "a" } }, "a ", "\"a\" ", "a " },
        { new String[][] { { "a", "b", "c" } }, "a b c ", "\"a\" \"b\" \"c\" ", "a b c " },
        { new String[][] { { "a", "b", "c" }, { "1 ", "2", " 3" } }, "a b c 1  2  3 ", "\"1 \" \"2\" \" 3\" ",
            "1  2  3 " }, };
  ...
  private void checkToString(String[][] array2d, String expectedArray, String expectedArrayQuoted,
      String expectedList) {
  ...
  public void testStartsWithIgnoreCase() {
    Object[][] testCases = { { "a", "", true }, { "", "a", false }, { "a", "A", true }, { "aA", "b", false },
        { "aBc123", "ABC", true }, { "aBc123", "bc123", false }, };
  ...
  @Test
  public void testMd5() {
    Object[][] testCases = { { "a", "0cc175b9:c0f1b6a8:31c399e2:69772661:" },
        { "b", "92eb5ffe:e6ae2fec:3ad71c77:7531578f:" }, { "abc123", "e99a18c4:28cb38d5:f2608536:78922e03:" },
  ...
  public void testCountOccurrences() {
    ...
    Object[][] testCases = { { "", ' ', 0 }, { " ", ' ', 1 }, { "  ", ' ', 2 }, { "a", 'a', 1 }, { "a", 'b', 0 },
        { abra, 'b', 2 }, { abra, 'c', 1 }, { abra, 'd', 1 }, { abra, 'e', 0 }, };
  ...
  public void testReplicate() {
    Object[][] testCases = { { ' ', "   ", "", "" }, { '5', "555", " ", "   " }, { 'a', "aaa", "a", "aaa" },
        { 'Z', "ZZZ", "xYz", "xYzxYzxYz" }, };
  ...
  public void testProjectColumn() {
    ...
    Object[][] testCases = { { new String[] { "" }, 0, "", true, new String[] { "" } },
        { new String[] { "" }, 0, " ", true, new String[] { "" } },
        { new String[] { "" }, 1, " ", true, new String[] {} },
        { new String[] { "" }, 1, " ", false, new String[] { null } },
        { alpha, 0, " ", true, new String[] { "a", "x" } }, { alpha, 4, " ", true, new String[] { "c" } },
  ...
  public void testStripQuotes_Exceptions() {
    Object[][] testCases = { { "", StringIndexOutOfBoundsException.class },
        { "'", StringIndexOutOfBoundsException.class }, { " \"", RuntimeException.class },
        { "\" ", RuntimeException.class }, { "'b\"", RuntimeException.class }, { "\"b'", RuntimeException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() { checkStripQuotes(quotedString, null); }
      };
  ...
  public void testFirstNCharsToUpperCase() {
    Object[][] testCases = { { "abcdefg", 0, "abcdefg" }, { "abcdefg", 1, "Abcdefg" }, { "abcdefg", 2, "ABcdefg" },
        { "abcdefg", 7, "ABCDEFG" }, { "abcdefg", 8, "ABCDEFG" }, };
