...
public class ValidOrTimeAndVersionRetentionPolicyTest {
  ...
  private static final ValidOrTimeAndVersionRetentionPolicy defaultPolicy =
      ValidOrTimeAndVersionRetentionPolicy.template;
  private static final ValidOrTimeAndVersionRetentionPolicy defaultPolicyCopy =
      new ValidOrTimeAndVersionRetentionPolicy(
      mCopy, mvCopy, tssCopy);
  private static final ValidOrTimeAndVersionRetentionPolicy defaultPolicyAlmostCopy =
      new ValidOrTimeAndVersionRetentionPolicy(
      mCopy, mvCopy, tssDiff);
  private static final ValidOrTimeAndVersionRetentionPolicy defaultPolicyDiff =
      new ValidOrTimeAndVersionRetentionPolicy(
      mDiff, mvDiff, tssDiff);

  @Test
  public void testGetters() {
    Object[][] testCases = { { SingleReverseSegmentWalk, getImplementationType(defaultPolicy) }
        //            {new ValidOrTimeAndVersionRetentionPolicy(), getInitialState(defaultPolicy)},    // FIXME:bph:
        //             currently no equals on ValidOrTimeAndVersionRetentionPolicy so this will assert !equal
    };

    test_Getters(testCases);

    Object[][] testCases2 = { { defaultPolicy, mCopy, mvCopy, tssCopy },
  ...
  public void testRetains() {
    ...
    Object[][] testCasesFalse = { { defaultPolicyDiff, key, 0L, 0L, true, state, 0L, false }, };
  ...
  public void testEqualsObject() {
    ValidOrTimeAndVersionRetentionPolicy[][] testCases = { { defaultPolicy, defaultPolicy, defaultPolicyDiff },
  ...
  public void testToStringAndParse() {
    ValidOrTimeAndVersionRetentionPolicy[] testCases = { defaultPolicy, defaultPolicyCopy, defaultPolicyAlmostCopy,
        defaultPolicyDiff, };
