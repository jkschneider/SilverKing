...
public class DHTNodeOptionsReflectionTest {
  ...
  public void testReapPolicyReflection() {
    ...
    ReapPolicy p2 = new LRUReapPolicy(true, true, false, 1000, 2000, 3000, true);
    ReapPolicy p3 = new ReapOnIdlePolicy();
    ReapPolicy p4 = new ReapOnIdlePolicy(true, true, false, true, false, 1000, 500, 999, 777, 78, 182,
        ReapPolicy.EmptyTrashMode.BeforeAndAfterInitialReap);
