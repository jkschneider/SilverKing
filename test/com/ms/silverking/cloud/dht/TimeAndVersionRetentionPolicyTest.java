...
public class TimeAndVersionRetentionPolicyTest {
  ...
  private static final TimeAndVersionRetentionPolicy defaultPolicyCopy = new TimeAndVersionRetentionPolicy(mCopy,
      mvCopy, tssCopy);
  private static final TimeAndVersionRetentionPolicy defaultPolicyAlmostCopy = new TimeAndVersionRetentionPolicy(mCopy,
      mvCopy, tssDiff);
  private static final TimeAndVersionRetentionPolicy defaultPolicyDiff = new TimeAndVersionRetentionPolicy(mDiff,
      mvDiff, tssDiff);
  ...
  public void testEqualsObject() {
    TimeAndVersionRetentionPolicy[][] testCases = { { defaultPolicy, defaultPolicy, defaultPolicyDiff },
  ...
  public void testToStringAndParse() {
    TimeAndVersionRetentionPolicy[] testCases = { defaultPolicy, defaultPolicyCopy, defaultPolicyAlmostCopy,
        defaultPolicyDiff, };
