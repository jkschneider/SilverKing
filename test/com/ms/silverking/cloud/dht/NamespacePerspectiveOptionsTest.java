...
public class NamespacePerspectiveOptionsTest {
  ...
  public static final ConstantVersionProvider vpCopy = new ConstantVersionProvider(
      standardVersionProvider.getVersion());
  public static final AbsMillisVersionProvider vpDiff = new AbsMillisVersionProvider(
      new ConstantAbsMillisTimeSource(0));
  ...
  private static final NamespacePerspectiveOptions<byte[], byte[]> defaultNspOptions =
      NamespacePerspectiveOptions.templateOptions;
  private static final NamespacePerspectiveOptions<byte[], byte[]> defaultNspOptionsCopy =
      new NamespacePerspectiveOptions<>(
      kcCopy, vcCopy, kdtCopy, poCopy, ioCopy, goCopy, woCopy, vpCopy, edCopy);
  private static final NamespacePerspectiveOptions<byte[], byte[]> defaultNspOptionsAlmostCopy =
      new NamespacePerspectiveOptions<>(
      kcCopy, vcCopy, kdtCopy, poCopy, ioCopy, goCopy, woCopy, vpCopy, edDiff);
  private static final NamespacePerspectiveOptions<IllegalArgumentException, Enum> defaultNspOptionsDiff =
      new NamespacePerspectiveOptions<>(
      kcDiff, vcDiff, kdtDiff, poDiff, ioDiff, goDiff, woDiff, vpDiff, edDiff);
  ...
  public void testGetters() {
    Object[][] testCases = { { byte[].class, getKeyClass(defaultNspOptions) }, { byte[].class, getValueClass(
        defaultNspOptions) }, { standardKeyDigestType, getKeyDigestType(defaultNspOptions) },
        ...
        { standardGetOptions, getDefaultGetOptions(defaultNspOptions) }, { standardWaitOptions, getDefaultWaitOptions(
        defaultNspOptions) }, { standardVersionProvider, getDefaultVersionProvider(defaultNspOptions) },
  ...
  public void testSetters_Exceptions() {
    Object[][] testCases = { { "keyClass = null", new ExceptionChecker() {
      @Override
      public void check() { setKeyClass(null); }
    }, NullPointerException.class }, { "valueClass = null", new ExceptionChecker() {
      @Override
      public void check() { setValueClass(null); }
    }, NullPointerException.class }, { "keyDigestType = null", new ExceptionChecker() {
      @Override
      public void check() { setKeyDigestType(null); }
    ...
    }, NullPointerException.class }, { "defaultVersionProvider = null", new ExceptionChecker() {
      @Override
      public void check() { setDefaultVersionProvider(null); }
  ...
  public void testSetters() {
    ...
    Object[][] testCases = { { kcDiff, getKeyClass(setKeyClass(kcDiff)) }, { vcDiff, getValueClass(
        setValueClass(vcDiff)) }, { poDiff, getDefaultPutOptions(setDefaultPutOptions(poDiff)) },
        ...
        setDefaultWaitOptions(woDiff)) }, { vpDiff, getDefaultVersionProvider(setDefaultVersionProvider(vpDiff)) },
  ...
  public void testEqualsObject() {
    NamespacePerspectiveOptions<?, ?>[][] testCases = { { defaultNspOptions, defaultNspOptions, defaultNspOptionsDiff },
        ...
        { defaultNspOptionsDiff, defaultNspOptionsDiff, defaultNspOptions }, { defaultNspOptions, setKeyClass(kcCopy),
        setKeyClass(kcDiff) }, { defaultNspOptions, setValueClass(vcCopy), setValueClass(vcDiff) },
    ...
    test_NotEquals(new Object[][] { { defaultNspOptions, NamespaceOptions.templateOptions }, });
  }

  @Test
  public void testToStringAndParse() {
    NamespacePerspectiveOptions<?, ?>[] testCases = { defaultNspOptions, defaultNspOptionsCopy,
        defaultNspOptionsAlmostCopy, defaultNspOptionsDiff, };
