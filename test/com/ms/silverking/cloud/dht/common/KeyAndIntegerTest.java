...
public class KeyAndIntegerTest {
  ...
  public void testGetters() {
    Object[][] testCases = { { ki, 0L, 1L, 3 }, { kiCopy, 0L, 1L, 3 }, };
  ...
  public void testEqualsObject() {
    test_Equals(new KeyAndInteger[][] { { ki, ki }, { kiCopy, ki }, });

    test_NotEquals(new KeyAndInteger[][] { { ki, kiSemiCopy }, { ki, kiDiff }, });
  }

  @Test
  public void testToString() {
    Object[][] testCases = { { ki, "0:1:3" }, { kiCopy, "0:1:3" }, { kiSemiCopy, "1:1:3" }, { kiDiff, "1:2:3" }, };
