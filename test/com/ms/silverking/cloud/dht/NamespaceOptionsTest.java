...
public class NamespaceOptionsTest {
  ...
  // defaultNspOptions, important for comparing reference vs value, i.e. hashCode and equals)
  ...
  private static final NamespaceOptions defaultNsOptionsCopy = new NamespaceOptions(stCopy, cpCopy, nsvmCopy, rmCopy,
      poCopy, ioCopy, goCopy, woCopy, ssisCopy, ssCopy, mvsCopy, alCopy, sfCopy, vrpCopy, nsscCopy);
  private static final NamespaceOptions defaultNsOptionsAlmostCopy = new NamespaceOptions(stCopy, cpCopy, nsvmCopy,
      rmCopy, poCopy, ioCopy, goCopy, woCopy, ssisCopy, ssCopy, mvsCopy, alCopy, sfCopy, vrpCopy, nsscDiff);
  private static final NamespaceOptions defaultNsOptionsDiff = new NamespaceOptions(stDiff, cpDiff, nsvmDiff, rmDiff,
      poDiff, ioDiff, goDiff, woDiff, ssisDiff, ssDiff, mvsDiff, alDiff, sfDiff, vrpDiff, nsscDiff);
  private static final NamespaceOptions defaultNsOptionsNsscNull1 = new NamespaceOptions(stDiff, cpDiff, nsvmDiff,
      rmDiff, poDiff, ioDiff, goDiff, woDiff, ssisDiff, ssDiff, mvsDiff, alDiff, sfDiff, vrpDiff, nsscNull);
  private static final NamespaceOptions defaultNsOptionsNsscNull2 = new NamespaceOptions(stDiff, cpDiff, nsvmDiff,
      rmDiff, poDiff, ioDiff, goDiff, woDiff, ssisDiff, ssDiff, mvsDiff, alDiff, sfDiff, vrpDiff, null);
  ...
  public void testGetters() {
    Object[][] testCases = { { defaultStorageType, getStorageType(defaultNsOptions) },
        { defaultConsistencyProtocol, getConsistencyProtocol(defaultNsOptions) }, { defaultVersionMode, getVersionMode(
        defaultNsOptions) }, { defaultRevisionMode, getRevisionMode(defaultNsOptions) },
        ...
        { standardGetOptions, getDefaultGetOptions(defaultNsOptions) }, { standardWaitOptions, getDefaultWaitOptions(
        defaultNsOptions) }, { defaultSecondarySyncIntervalSeconds, getSecondarySyncIntervalSeconds(defaultNsOptions) },
        { defaultSegmentSize, getSegmentSize(defaultNsOptions) }, { defaultMaxValueSize, getMaxValueSize(
        defaultNsOptions) }, { defaultAllowLinks, getAllowLinks(defaultNsOptions) },
  ...
  // this takes care of testing ctors as well b/c the class' setter functions implementation is calling the
  // constructor - builder pattern
  @Test
  public void testSetters_Exceptions() {
    Object[][] testCases = { { "storageType = null", new ExceptionChecker() {
      @Override
      public void check() { setStorageType(null); }
    }, NullPointerException.class }, { "consistencyProtocol = null", new ExceptionChecker() {
      @Override
      public void check() { setConsistencyProtocol(null); }
    }, NullPointerException.class }, { "versionMode = null", new ExceptionChecker() {
      @Override
      public void check() { setVersionMode(null); }
    }, NullPointerException.class }, { "revisionMode = null", new ExceptionChecker() {
      @Override
      public void check() { setRevisionMode(null); }
    }, NullPointerException.class }, { "defaultPutOptions = null", new ExceptionChecker() {
      @Override
      public void check() { setDefaultPutOptions(null); }
    }, NullPointerException.class }, { "defaultPutOptions = invalidationOptions", new ExceptionChecker() {
      @Override
      public void check() { setDefaultPutOptions(standardInvalidationOptions); }
    }, IllegalArgumentException.class }, { "defaultInvalidationOptions = null", new ExceptionChecker() {
      @Override
      public void check() { setDefaultInvalidationOptions(null); }
    }, NullPointerException.class }, { "defaultGetOptions = null", new ExceptionChecker() {
      @Override
      public void check() { setDefaultGetOptions(null); }
    }, NullPointerException.class }, { "defaultWaitOptions = null", new ExceptionChecker() {
      @Override
      public void check() { setDefaultWaitOptions(null); }
    }, NullPointerException.class }, { "segmentSize = min-1", new ExceptionChecker() {
      @Override
      public void check() { setSegmentSize(minMaxValueSize - 1); }
    }, ConstraintViolationException.class }, { "segmentSize = min-1", new ExceptionChecker() {
      @Override
      public void check() { setSegmentSize(minSegmentSize - 1); }
    }, ConstraintViolationException.class }, { "segmentSize = max+1", new ExceptionChecker() {
      @Override
      public void check() { setSegmentSize(maxSegmentSize + 1); }
    }, ConstraintViolationException.class }, { "maxValueSize = min-1", new ExceptionChecker() {
      @Override
      public void check() { setMaxValueSize(minMaxValueSize - 1); }
    }, ConstraintViolationException.class }, { "maxValueSize = max+1", new ExceptionChecker() {
      @Override
      public void check() { setMaxValueSize(maxMaxValueSize + 1); }
  ...
  public void testSetters() {
    ...
    Object[][] testCases = { { poDiff, getDefaultPutOptions(setDefaultPutOptions(poDiff)) },
        { ioDiff, getDefaultInvalidationOptions(setDefaultInvalidationOptions(ioDiff)) },
        { goDiff, getDefaultGetOptions(setDefaultGetOptions(goDiff)) }, { woDiff, getDefaultWaitOptions(
        setDefaultWaitOptions(woDiff)) }, { vrpDiff, getValueRetentionPolicy(setValueRetentionPolicy(vrpDiff)) }, };
  ...
  public void testEqualsObject() {
    NamespaceOptions[][] testCases = { { defaultNsOptions, defaultNsOptions, defaultNsOptionsDiff },
        ...
        { defaultNsOptionsNsscNull1, defaultNsOptionsNsscNull2, defaultNsOptions }, { defaultNsOptions, setStorageType(
        stCopy), setStorageType(stDiff) }, { defaultNsOptions, setConsistencyProtocol(cpCopy), setConsistencyProtocol(
        cpDiff) }, { defaultNsOptions, setVersionMode(nsvmCopy), setVersionMode(nsvmDiff) },
        ...
        { defaultNsOptions, setSegmentSize(ssCopy), setSegmentSize(ssDiff) }, { defaultNsOptions, setMaxValueSize(
        mvsCopy), setMaxValueSize(mvsDiff) }, { defaultNsOptions, setAllowLinks(alCopy), setAllowLinks(alDiff) },
    ...
    test_NotEquals(new Object[][] { { defaultNsOptions, NamespacePerspectiveOptions.templateOptions }, });
  }
