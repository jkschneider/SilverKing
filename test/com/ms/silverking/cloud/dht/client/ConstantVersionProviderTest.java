...
public class ConstantVersionProviderTest {
  ...
  public void testVersion() {
    Object[][] testCases = { { v, constantProvider }, { vCopy, constantProviderCopy },
  ...
  public void testEqualsObject() {
    ConstantVersionProvider[][] testCases = { { constantProvider, constantProvider, constantProviderDiff },
    ...
    test_NotEquals(new Object[][] { { constantProvider, absMillisProvider }, { constantProvider, absNanosProvider },
