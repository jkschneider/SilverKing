...
public class RelNanosVersionProviderTest {
  ...
  public void testHashCode() {
    ...
    checkHashCodeNotEquals(relNanosProvider,
        relNanosProviderCopy);    // TimerDrivenTimeSource - SafeTimer - uses object identity for hashCode
    checkHashCodeNotEquals(relNanosProvider, relNanosProviderDiff);
  }

  public void testEqualsObject() {
    RelNanosVersionProvider[][] testCases = { { relNanosProvider, relNanosProvider, relNanosProviderDiff },
        { relNanosProviderDiff, relNanosProviderDiff, relNanosProvider }, };
    test_FirstEqualsSecond_FirstNotEqualsThird(testCases);

    test_NotEquals(new Object[][] { { relNanosProvider, absMillisProvider }, { relNanosProvider, absNanosProvider },
        { relNanosProvider, constantProvider }, { relNanosProvider, relNanosProviderCopy },
        // TimerDrivenTimeSource - SafeTimer - uses object identity for equals
    });
  }
}
