...
public class TestUtil {
  ...
  public static final byte[] negOneCopy = {
      -1 };    // important to make copy rather than re-use, negOne byte array, for testing equals and hashCode
  public static final byte[] empty = {};
  public static final byte[] posOne = { 1 };
  public static final byte[] byte_minToMax = { byte_minVal, -1, 0, 1, byte_maxVal };
  public static final byte[] byte_minToMaxCopy = { byte_minVal, -1, 0, 1,
      byte_maxVal };    // important to make copy rather than re-use, byte_minToMax byte array, for testing equals
  // and hashCode
