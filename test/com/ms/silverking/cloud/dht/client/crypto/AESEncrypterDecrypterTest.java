...
public class AESEncrypterDecrypterTest {
  ...
  private static final EncrypterDecrypter[][] testCasesNotEquals = { { negOneAES, emptyAES }, { emptyAES, posOneAES },
      { posOneAES, m2mAES }, { m2mAES, negOneAES }, { m2mAES, m2mXORCopy },    // aes vs xor
  };
  ...
  // already tested in static variables above, and ctor 'secureRandom.generateSeed(16)' takes a lot of time, so
  // commenting out is to speed up overall test runtime
  //    @Test
  ...
  public void testEncryptDecrypt() {
    ...
    Object[][] testCases = { { negOne, negOneAES }, { empty, emptyAES }, { posOne, posOneAES },
