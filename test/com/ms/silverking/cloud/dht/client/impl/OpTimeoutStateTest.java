...
public class OpTimeoutStateTest {
  ...
  public OpTimeoutStateTest() {
    opSizeBasedTimeoutState = new OpTimeoutState(null, OpSizeBasedTimeoutControllerTest.defaultController,
        zeroTimeMillis);
  ...
  public void testOpHasTimedOut() {
    Object[][] testCases = { { opSizeBasedTimeoutState, zeroTimeMillis, false },
        ...
        //            {waitForTimeoutState,     (long)fixme,          false}, // NPE if AsyncOperation param is null,
        //             testing with null b/c it's too much work to create an actual AsyncOperation...
        //            {waitForTimeoutState,     (long)fixme+1,         true}, // NPE if AsyncOperation param is null,
        //             testing with null b/c it's too much work to create an actual AsyncOperation...
    };
    ...
    Object[][] testCases_curAttemptIndex = {
        { opSizeBasedTimeoutState, opSizeBasedTimeoutController_defaultMaxAttempts, false },
        { simpleTimeoutState, simpleTimeoutController_defaultMaxAttempts, false },
        { waitForTimeoutState, 4, true }, // wait controller allows up to max int attempts
    };
    ...
    for (Object[] testCase : testCases_curAttemptIndex) {
      ...
      boolean expected = (boolean) testCase[2];
      AsyncOperation mockOp = mock(AsyncOperation.class);
  ...
  public void testRetryOnExclusionChange() {
    Object[][] testCases = { { opSizeBasedTimeoutState, zeroTimeMillis, false },
        ...
        { opSizeBasedTimeoutState, (long) opSizeBasedTimeoutController_defaultExclusionChangeRetryIntervalMS + 1,
            true }, { simpleTimeoutState, zeroTimeMillis, false },
        { simpleTimeoutState, (long) simpleTimeoutController_getRelativeExclusionChangeRetryMillisForAttempt, false },
        { simpleTimeoutState, (long) simpleTimeoutController_getRelativeExclusionChangeRetryMillisForAttempt + 1,
            true }, { waitForTimeoutState, zeroTimeMillis, false },
        { waitForTimeoutState, (long) waitForTimeoutController_defaultExclusionChangeInternalRetryIntervalSeconds,
            false },
        { waitForTimeoutState, (long) waitForTimeoutController_defaultExclusionChangeInternalRetryIntervalSeconds + 1,
            true }, };
  ...
  public void testToString() {
    Object[][] testCases = {
        { "0:0:maxAttempts=4,constantTime_ms=300000,itemTime_ms=305,nonKeyedOpMaxRelTimeout_ms=1500000," +
            "exclusionChangeRetryInterval_ms=5000",
            opSizeBasedTimeoutState }, { "0:0:maxAttempts=5,maxRelativeTimeoutMillis=120000", simpleTimeoutState },
