...
public class AbsMillisVersionProviderTest {
  ...
  public void testVersion() {
    Object[][] testCases = { { 0L, absMillisProvider }, { 0L, absMillisProviderCopy },
  ...
  public void testEqualsObject() {
    AbsMillisVersionProvider[][] testCases = { { absMillisProvider, absMillisProvider, absMillisProviderDiff },
    ...
    test_NotEquals(new Object[][] { { absMillisProvider, absNanosProvider }, { absMillisProvider, constantProvider },
