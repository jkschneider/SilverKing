...
public class NamespaceCreationOptionsTest {
  ...
  private static final NamespaceCreationOptions defaultOptionsCopy = new NamespaceCreationOptions(
      Mode.OptionalAutoCreation_AllowMatches, "^_.*", DHTConstants.defaultNamespaceOptions);
  private static final NamespaceCreationOptions defaultOptionsAlmostCopy = new NamespaceCreationOptions(
      Mode.OptionalAutoCreation_AllowMatches, "^_.*", null);
  private static final NamespaceCreationOptions defaultOptionsDiff = new NamespaceCreationOptions(
      Mode.OptionalAutoCreation_DisallowMatches, "", DHTConstants.defaultNamespaceOptions);

  @Test
  public void testCanBeExplicitlyCreated() {
    Object[][] testCases = { { RequireExplicitCreation, "", null, true }, { RequireAutoCreation, "", null, false },
  ...
  public void testCanBeAutoCreated() {
    Object[][] testCases = { { RequireExplicitCreation, "", null, "", false },
        { RequireAutoCreation, "", null, "", true }, { OptionalAutoCreation_AllowMatches, "^_.*", null, "abc", false },
  ...
  public void testToStringAndParse() {
    NamespaceCreationOptions[] testCases = { defaultOptions, defaultOptionsCopy, defaultOptionsAlmostCopy,
        defaultOptionsDiff, };
