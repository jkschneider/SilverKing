...
public class AlertTest {
  ...
  public void testGetters() {
    Object[][] testCases = { { context, alert.getContext() }, { level, alert.getLevel() }, { key, alert.getKey() },
        { message, alert.getMessage() }, { data, alert.getData() }, { "", alertDiff_NullData.getData() }, };
  ...
  public void testConstructor_NullExceptions() {
    Object[][] testCases = { { "context = null", new ExceptionChecker() {
      @Override
      public void check() { new Alert(null, 0, null, null, null); }
    }, NullPointerException.class }, { "key = null", new ExceptionChecker() {
      @Override
      public void check() { new Alert("", 0, null, null, null); }
    }, NullPointerException.class }, { "message = null", new ExceptionChecker() {
      @Override
      public void check() { new Alert("", 0, "", null, null); }
  ...
  public void testEqualsObject() {
    Alert[][] testCases = { { alert, alert, alertDiff_NullData }, { alertCopy, alert, alertDiff_NullData },
  ...
  public void testToString() {
    Object[][] testCases = { { alertTestExpectedToString, alert }, { alertTestExpectedToString, alertDiff_NullData }, };
