...
public class PropertiesHelperTest {
  ...
  public void testGetStringAllParams_Exceptions() {
    Object[][] testCases = { { null, null, null, NullPointerException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() { checkGetStringAllParams(name, defaultValue, undefinedAction, null); }
      };
  ...
  public void testGetStringAllParams() {
    Object[][] testCases = { { key1, null, null, value1 }, { keyA, null, ZeroOnUndefined, null },
        { keyA, null, DefaultOnUndefined, null }, { keyA, "b", DefaultOnUndefined, "b" }, };
  ...
  public void testGetIntAllParams_Exceptions() {
    Object[][] testCases = { { null, -1, null, null, NullPointerException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      String testMessage = getTestMessage("getInt_Exceptions", name, defaultValue, undefinedAction,
          parseExceptionAction);
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() { checkGetIntAllParams(name, defaultValue, undefinedAction, parseExceptionAction, -1); }
      };
      exceptionNameChecker(ec, testMessage, expectedExceptionClass);
    }
  }
  ...
  public void testGetIntAllParams() {
    Object[][] testCases = { { keyInt1, -1, null, null, Integer.parseInt(valueInt1) },
        { keyInt2, -1, null, DefaultOnParseException, -1 }, { keyA, -1, ZeroOnUndefined, null, 0 },
  ...
  public void testGetBooleanAllParams_Exceptions() {
    Object[][] testCases = { { null, true, null, null, NullPointerException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      String testMessage = getTestMessage("getBoolan_Exceptions", name, defaultValue, undefinedAction,
          parseExceptionAction);
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() {
          checkGetBooleanAllParams(name, defaultValue, undefinedAction, parseExceptionAction, false);
        }
      };
      exceptionNameChecker(ec, testMessage, expectedExceptionClass);
    }
  ...
  public void testGetBooleanAllParams() {
    Object[][] testCases = { { keyBool, true, null, null, Boolean.parseBoolean(valueBool) },
        { keyInt1, true, null, DefaultOnParseException, true }, { keyA, true, ZeroOnUndefined, null, false },
  ...
  public void testGetLongAllParams_Exceptions() {
    Object[][] testCases = { { null, -1L, null, null, NullPointerException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      String testMessage = getTestMessage("getLong_Exceptions", name, defaultValue, undefinedAction,
          parseExceptionAction);
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() { checkGetLongAllParams(name, defaultValue, undefinedAction, parseExceptionAction, -1L); }
      };
      exceptionNameChecker(ec, testMessage, expectedExceptionClass);
    }
  }
  ...
  public void testGetLongAllParams() {
    Object[][] testCases = { { keyLong, -1L, null, null, Long.parseLong(valueLong) },
        { keyInt2, -1L, null, DefaultOnParseException, -1L }, { keyA, -1L, ZeroOnUndefined, null, 0L },
  ...
  public void testGetEnumAllParams_Exceptions() {
    Object[][] testCases = { { null, Compression.BZIP2, null, null, NullPointerException.class },
    ...
    for (Object[] testCase : testCases) {
      ...
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() {
          checkGetEnumAllParams(name, defaultValue, undefinedAction, parseExceptionAction, Compression.BZIP2);
        }
      };
      exceptionNameChecker(ec, testMessage, expectedExceptionClass);
    }
  ...
  public void testGetEnumAllParams() {
    Object[][] testCases = { { keyEnum, Compression.BZIP2, null, null, Compression.valueOf(valueEnum) },
