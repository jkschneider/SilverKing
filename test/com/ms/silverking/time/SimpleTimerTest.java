...
public class SimpleTimerTest {
  ...
  private ExceptionChecker startEc = new ExceptionChecker() {
    @Override
    public void check() { startTimer(); }
  };
  private ExceptionChecker stopEc = new ExceptionChecker() {
    @Override
    public void check() { stopTimer(); }
  };
  private ExceptionChecker resetEc = new ExceptionChecker() {
    @Override
    public void check() { resetTimer(); }
  };

  private ExceptionChecker elapsedNanosEc = new ExceptionChecker() {
    @Override
    public void check() { getElapsedNanos(); }
  };
  private ExceptionChecker elapsedMillisLongEc = new ExceptionChecker() {
    @Override
    public void check() { getElapsedMillisLong(); }
  };
  private ExceptionChecker elapsedMillisEc = new ExceptionChecker() {
    @Override
    public void check() { getElapsedMillis(); }
  };
  private ExceptionChecker elapsedSecondsEc = new ExceptionChecker() {
    @Override
    public void check() { getElapsedSeconds(); }
  };
  private ExceptionChecker elapsedSecondsBDEc = new ExceptionChecker() {
    @Override
    public void check() { getElapsedSecondsBD(); }
  };
  ...
  public void testGetElapsed() {
    ...
    checkNanos(getElapsedNanos(), getElapsedMillisLong(), getElapsedMillis(), getElapsedSeconds(),
        getElapsedSecondsBD());
  }
  ...
  private void checkNanos(long nanos, long nanosMillis, int nanosMillisInt, double nanosSeconds,
      BigDecimal nanosSecondsBD) {
  ...
  public void testGetTimeLimit() {
    ...
    checkNanos(getTimeLimitNanos(), getTimeLimitMillisLong(), getTimeLimitMillis(), nanosSeconds,
        getTimeLimitSecondsBD());
  }
}
