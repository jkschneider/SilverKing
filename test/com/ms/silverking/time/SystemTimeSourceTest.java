...
public class SystemTimeSourceTest {
  ...
  public void testEqualsObject() {
    SystemTimeSource[][] testCases = { { systemSource, systemSource, systemSourceDiff },
        { systemSourceDiff, systemSourceDiff, systemSource }, };
    test_FirstEqualsSecond_FirstNotEqualsThird(testCases);

    test_NotEquals(new Object[][] { { systemSource, TestUtil.constantSource }, { systemSource, TestUtil.timerSource },
