...
public class TimerDrivenTimeSourceTest {
  ...
  public void testEqualsObject() {
    TimerDrivenTimeSource[][] testCases = { { timerSource, timerSource, timerSourceDiff },
        { timerSourceDiff, timerSourceDiff, timerSource }, };
    test_FirstEqualsSecond_FirstNotEqualsThird(testCases);

    test_NotEquals(new Object[][] { { timerSource, TestUtil.constantSource }, { timerSource, TestUtil.systemSource },
