...
public class NumArgValidatorTest {
  ...
  public void testEnsureRegularDouble() {
    double[] testCases = { -double_maxVal, 0.0d, double_minVal, double_minNorm, double_maxVal, };
  ...
  public void testEnsurePositiveRegularDouble_Exceptions() {
    double[] testCases = { double_nan, double_negInf, double_posInf, -double_maxVal, 0.0d, };

    for (double testCase : testCases) {
      String testMessage = getTestMessage("ensurePositiveRegularDouble_Exceptions", testCase);
      ExceptionChecker ec = new ExceptionChecker() {
        @Override
        public void check() { checkEnsurePositiveRegularDouble(testCase); }
      };
      exceptionNameChecker(ec, testMessage, IllegalArgumentException.class);
    }
  }
  ...
  public void testEnsurePositiveRegularDouble() {
    double[] testCases = { double_minVal, double_minNorm, double_maxVal, };
