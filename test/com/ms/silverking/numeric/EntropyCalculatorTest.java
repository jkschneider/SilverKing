...
public class EntropyCalculatorTest {
  ...
  public void testComputeEntropy() {
    Object[][] testCases = { { new byte[] { 0 }, 0.0d }, { new byte[] { 0, 0 }, 0.0d }, { new byte[] { 0, 1 }, 1.0d },
        { new byte[] { 1, 0 }, 1.0d }, { new byte[] { 0, 1, 2 }, 1.584962500721156d },
        { new byte[] { 2, 1, 0 }, 1.584962500721156d }, { new byte[] { -1, 0, 1 }, 1.584962500721156d },
        { new byte[] { -3, -2, -1, 0, 1, 2, 3 }, 2.8073549220576046 }, { new byte[] { -5, -5, -5, 5, 5, 5 }, 1.0d },
