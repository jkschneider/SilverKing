...
public class LongIntervalTest {
  ...
  public void testGettersAndToString() {
    long[][] testCases = { { 0, 0, 1 }, { 0, 1, 2 }, { -4_123_456_789L, 7_568_123, 4_131_024_913L }, };
  ...
  public void testEquals() {
    ...
    Object[][] testCases = { { zeroZero, zeroZero, true, true }, { zeroOne, zeroZero, false, false },
        { zeroOne, zeroOne, true, true }, { zeroOne, oneOne, false, false },

        { zeroZero, createInterval(0, 0), true, true }, { createInterval(-4_123_456_789L, 7_568_123), createInterval(
        -4_123_456_789L, 7_568_123), true, true }, };
